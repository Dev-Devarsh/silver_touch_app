        ...
        drawer: Drawer(
          ...
          child: Padding(
            ...
            child: ListView.separated(
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      ...
                      AppRouter.goToNextPage(context, routeList[index]).then((value) {
                        _userCubit.getAllContacts();
                      });
                    },
                    child: ListTile(
                ...
                separatorBuilder: (context, index) => Divider(color: AppColor.scaffoldDevider),
                itemCount: 2),
          ),
        ),
